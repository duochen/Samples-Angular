...
export function myCustomLogServiceFactory() {
  const service = new MyCustomLogService();
  service.setPrefix('(my factory demo)');
  return service;
}
...
@NgModule({
  ...
  providers: [
    { provide: MyCustomLogService, useFactory: myCustomLogServiceFactory },
    // { provide: 'CustomLogService', useClass: MyCustomLogService},
